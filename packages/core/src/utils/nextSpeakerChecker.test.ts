...
import { AlfredChat } from '../core/alfredChat.js';
...
describe('checkNextSpeaker', () => {
  ...
  beforeEach(() => {
    ...
    // AlfredChat will receive the mocked instances via the mocked GoogleGenAI constructor
    chatInstance = new AlfredChat(
      mockConfig,
      {},
      [], // initial history
    );
