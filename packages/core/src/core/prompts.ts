...
export function getCoreSystemPrompt(userMemory?: string): string {
  ...
  const basePrompt = systemMdEnabled
    ...
    : `
You are Alfred, an interactive CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and efficiently, adhering strictly to the following instructions and utilizing your available tools.
