...
import type { IModel } from '../../providers/index.js';
  ...
  const renderContent = () => {
      ...
      return (
        <Box flexDirection="column">
          ...
          <Box marginY={1}>
            ...
            <Text color={theme.text.primary}>{searchTerm}</Text>
          </Box>
    ...
    return (
      <Box flexDirection="column">
        ...
        {/* Search input */}
        <Box marginY={1}>
          <Text color={isSearching ? theme.text.primary : theme.text.secondary}>
            search: {isSearching && <Text color={theme.text.accent}>▌</Text>}
          </Text>
          <Text color={theme.text.primary}>{searchTerm}</Text>
        </Box>
        ...
        <Text color={theme.text.secondary}>Tab to switch modes</Text>
      </Box>
    );
  };
