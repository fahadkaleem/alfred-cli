...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @alfred/alfred-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @alfred/alfred-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @alfred/alfred-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @alfred/alfred-cli@latest';
    return {
