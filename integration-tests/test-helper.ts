...
export class TestRig {
  ...
  getDefaultTimeout() {
    ...
    if (env.ALFRED_SANDBOX) return 30000; // 30s in containers
  ...
  setup(
    ...
    const geminiDir = join(this.testDir, '.alfred');
    ...
    const settings = {
      ...
      sandbox: env.ALFRED_SANDBOX !== 'false' ? env.ALFRED_SANDBOX : false,
